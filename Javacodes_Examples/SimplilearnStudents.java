...
public class SimplilearnStudents
{
 //Mapper class
...
//Reduce function
 ...
 {
 JobConf conf = new JobConf(SimplilearnStudents.class);
 conf.setJobName("InterestedStudents");
 conf.setOutputKeyClass(Text.class);
 conf.setOutputValueClass(IntWritable.class);
 conf.setMapperClass(EMapper.class);
 conf.setCombinerClass(EReduce.class);
 conf.setReducerClass(EReduce.class);
